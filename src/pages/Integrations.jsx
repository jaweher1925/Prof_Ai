  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-2xl font-light text-white tracking-wide">Integrations</h1>
      </div>
          ...
          <Card key={item.name}>
            <CardContent className="p-4 flex items-start gap-4">
              ...
              <div>
                ...
                <code className="text-xs text-slate-600 mt-1 block">{item.key}</code>
              </div>
            </CardContent>
          </Card>
        ))}
      ...
      <div className="mt-8 p-4 rounded-xl bg-indigo-500/5 border border-indigo-500/20">
        <p className="text-xs text-slate-400 leading-relaxed">
          To configure: go to your <strong className="text-white">Azure Static Web App → Settings → Environment variables</strong> and add the keys listed above.
