...
INSERT INTO "new_slide_compositions" ("avatar_width", "avatar_x", "avatar_y", "content_blocks", "created_at", "id", "image_height", "image_url", "image_width", "image_x", "image_y", "scene_id", "status", "template_id", "title", "updated_at") SELECT "avatar_width", "avatar_x", "avatar_y", "content_blocks", "created_at", "id", "image_height", "image_url", "image_width", "image_x", "image_y", "scene_id", "status", "template_id", "title", "updated_at" FROM "slide_compositions";
