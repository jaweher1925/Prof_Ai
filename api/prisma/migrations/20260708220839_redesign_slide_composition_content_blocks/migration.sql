/*
  ...
  - You are about to drop the column `key_points` on the `slide_compositions` table. All the data in the column will be lost.
  - You are about to drop the column `main_point` on the `slide_compositions` table. All the data in the column will be lost.
...
INSERT INTO "new_slide_compositions" ("avatar_width", "avatar_x", "avatar_y", "created_at", "id", "image_height", "image_url", "image_width", "image_x", "image_y", "scene_id", "status", "template_id", "title", "updated_at") SELECT "avatar_width", "avatar_x", "avatar_y", "created_at", "id", "image_height", "image_url", "image_width", "image_x", "image_y", "scene_id", "status", "template_id", "title", "updated_at" FROM "slide_compositions";
