...
INSERT INTO "new_slide_compositions" ("avatar_width", "avatar_x", "avatar_y", "content_blocks", "content_edited", "content_x", "content_y", "created_at", "id", "image_height", "image_url", "image_width", "image_x", "image_y", "scene_id", "status", "subtitle", "template_id", "title", "updated_at") SELECT "avatar_width", "avatar_x", "avatar_y", "content_blocks", "content_edited", "content_x", "content_y", "created_at", "id", "image_height", "image_url", "image_width", "image_x", "image_y", "scene_id", "status", "subtitle", "template_id", "title", "updated_at" FROM "slide_compositions";
